			...
			.extend(
					$.validator,
					{
						...
						messages : {
							...
							digits : "Por favor ingrese sÃ³lo dÃ­gitos.",
							creditcard : "Por favor introduzca un nÃºmero de tarjeta de crÃ©dito vÃ¡lida.",
							equalTo : "Las contrase&ntilde;as no coinciden",
							equalmailTo : "Por favor introduce el mismo correo que arriba.",
							accept : "Por favor introduzca un valor con una extensiÃ³n vÃ¡lida.",
							maxlength : $.validator
									.format("Por favor introduce no mÃ¡s de {0} caracteres."),
							minlength : $.validator
									.format("Por favor introduzca al menos {0} caracteres."),
							rangelength : $.validator
									.format("Please enter a value between {0} and {1} characters long."),
							range : $.validator
									.format("Por favor introduzca un valor entre {0} y {1}."),
							max : $.validator
									.format("Por favor introduzca un valor menor o igual a {0}."),
							min : $.validator
									.format("Por favor introduzca un valor mayor o igual a {0}."),
							specialChars : $.validator
									.format("La contraseÃ±a no debe contener espacios ni caracteres especiales"),
							customvalidation : $.validator
									.format("No puede utilizar numeros o caracteres especiales en este campo"),
						},
						...
						methods : {
							...
							specialChars : function(value, element) {
								return this.optional(element)
							...
							equalmailTo : function(value, element, param) {
								var target = $(param).unbind(
										".validate-equalTo").bind(
										"blur.validate-equalTo", function() {
											$(element).valid();
