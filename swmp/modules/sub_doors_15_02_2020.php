    ...
    <?php for($i=0;$i<count($select_all);$i++) {?>
      <tr>
        ...
        <td><?=$select_all[$i]['sub_door_name']?></td>
         <td><a href="sub_doors?update_id=<?= $select_all[$i]['sub_door_id']?>">Edit</a></td>
         <td><a href="sub_doors?delete_id=<?= $select_all[$i]['sub_door_id']?>" onclick="return ConfirmDialog('Are you sure You Want to delete!');">Delete</a></td>
