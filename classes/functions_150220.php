...
if ($pagename == 'addDoors') {
    ...
    if ((!isset($_REQUEST['delete_id']) && $_REQUEST['delete_id'] == '') &&
        (!isset($_REQUEST['update_id']) && $_REQUEST['update_id'] == '')) {
            ...
            if (isset($_POST['sub'])) {
                ...
                if (is_array($responce['ErrorFildes']) && ! empty($responce['ErrorFildes'])) {
                    ...
                    if ($responce != '0') {
                        header('Location: adddoors?msg=success');
                    }
                }
            }
        }
        ...
        if (isset($_REQUEST['delete_id']) && $_REQUEST['delete_id'] != '') {
            ...
            if ($responce != '0') {
                header('Location: adddoors?delete=success');
            }}
            ...
            if (isset($_REQUEST['update_id']) && $_REQUEST['update_id'] != '')
            {
                ...
                if (isset($_POST['sub'])) {
                    ...
                    if ($res != '0') {
                        header('Location: adddoors?update=success');
                    }
                }
            }
...
if ($pagename == 'sub_doors') {
    ...
    if ((!isset($_REQUEST['delete_id']) && $_REQUEST['delete_id'] == '') &&
        (!isset($_REQUEST['update_id']) && $_REQUEST['update_id'] == '')) {
            ...
            if (isset($_POST['sub'])) {
                ...
                if (is_array($responce['ErrorFildes']) && ! empty($responce['ErrorFildes'])) {
                    ...
                    if ($responce != '0') {
                        header('Location: sub_doors?msg=success');
                    }
                }
            }
        }
        ...
        if (isset($_REQUEST['delete_id']) && $_REQUEST['delete_id'] != '') {
            ...
            if ($responce != '0') {
                header('Location: sub_doors?delete=success');
            }}
            ...
            if (isset($_REQUEST['update_id']) && $_REQUEST['update_id'] != '')
            {
                ...
                if (isset($_POST['sub'])) {
                    ...
                    if ($res != '0') {
                        header('Location: sub_doors?update=success');
                    }
                }
            }
