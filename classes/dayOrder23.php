...
$doortype = '2023';
/************ Add User:start *************************************************************/
if (@$pagename == 'addOrder23') {
	


	if(isset($orderType) && $orderType === 'NewDayOrder')  $doortype = 'new'; else   $doortype = '2023';
	$selectconall = array(
        'deleted' => '0'
    );
    $selectcondoor = array(
...
function postdeatiles($update0rder,$opreation)
{
	if (isset($_POST['sub'])) {
		...
		$postdeatis = array(
				...
				'door_type' => $doortype,
				'color' => $responce['postdeatis']['fcolor'],
				'fcolor' => $responce['postdeatis']['fcolor'],
				'bcolor' => $responce['postdeatis']['bcolor'],
...
function performopteration($setoperations,$common,$conection)
{
	if($setoperations[3] == 'insert')
	{
	    ...
	    $responce = $common->insert($setoperations[0],$setoperations[2], $conection);
	}
...
if (isset($_POST['addorders'])) {
 ...
 if($resque != '0') {
 	...
 	$postdeatis = array(
			 ...
			 'fcolor' => $resque[$i]['fcolor'],
			 'bcolor' => $resque[$i]['bcolor'],
