    ...
    <div class="pull-left col-md-9">
      <div class="form-cont">
       ...
       <div class="row">
          ...
          <select  name="fcolor" id="fcolor" class="form-control {validate:{required:true,messages:{required:'<?=$onlyrequired?>'}}}">
    ...
    <?php for($i=0;$i<count($select_all);$i++) { 
      ...
      <tr>
        ...
        <!-- <td><a href="addOrder?update_id=< ?= $select_all[$i]['order_id']?>">Edit</a></td> --> 
         <td><a href="addOrder?delete_id=<?= $select_all[$i]['order_id']?>" onclick="return ConfirmDialog('Are you sure You Want to delete!');">Delete</a></td>
