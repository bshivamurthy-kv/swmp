...
<div class="container signup adduser">
  ...
  <div class="row">
    <div class="col-12-xs col-sm-10 col-lg-8 col-lg-offset-2 col-sm-offset-1">
      <div class="form-cont">
        <h3>Add Main Doors <span><a href="sub_doors">--Add Sub Doors--</a></span></h3>
    ...
    <?php for($i=0;$i<count($select_all);$i++) {?>
      ...
      <tr>
        <td><?=$select_all[$i]['door_name']?></td>
         <td><a href="adddoors?update_id=<?= $select_all[$i]['door_id']?>">Edit</a></td>
         <td><a href="adddoors?delete_id=<?= $select_all[$i]['door_id']?>" onclick="return ConfirmDialog('Are you sure You Want to delete!');">Delete</a></td>
