  ...
  <table id="example1" class="table table-bordered">
    ...
    <?php for($i=0;$i<count($select_all);$i++) { 
      ...
      <tr>
        ...
        <td><a href="DayOrder?update_id=<?= $select_all[$i]['order_id']?>">Edit</a></td>
         <td><a href="DayOrder?delete_id=<?= $select_all[$i]['order_id']?>" onclick="return ConfirmDialog('Are you sure You Want to delete!');">Delete</a></td>
